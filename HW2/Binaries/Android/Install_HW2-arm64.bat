...
%ADB% %DEVICE% shell pm list packages com.epicgames.HW2
...
%ADB% %DEVICE% shell rm -r %STORAGE%/Download/obb/com.epicgames.HW2
...
%ADB% %DEVICE% shell pm grant com.epicgames.HW2 android.permission.READ_EXTERNAL_STORAGE
%ADB% %DEVICE% shell pm grant com.epicgames.HW2 android.permission.WRITE_EXTERNAL_STORAGE
